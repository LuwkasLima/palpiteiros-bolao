...
- [ ] Devide the fixtures per day for better visualization in the UI
- [ ] Separate visually the list of boloes and the new bolao/enter bolao
- [ ] Add a short description under the greetning area where the name of the user is displayed
